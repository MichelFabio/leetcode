...
public class PlusOne {
    public int [] plusOne(int [] digits){
        ...
        //y pasa al siguiente dígito(de derecha a izquierda) si no encuentra un 9 establece el arreglo en esa posicion en el digito +1
        for (int i = 0; i < x; i++){
        ...
        //Si en el primer digito el de mayor significancia aparece un 0 esto indica que se debe añadir un digito nuevo al arreglo
